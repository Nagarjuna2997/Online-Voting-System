...
<body>
    ...
    <div class="body">
        <div class="veen">
			...
			<form:form id="login" method="post" action="/loginsub" modelAttribute="log">
			<form id="login" tabindex="500">
                    <h3>Login</h3>
                    <div class="mail">
			<form:input path="voterid" type="text" placeholder="Enter Your Id Number"/><br><br>
			<label>Student Id</label>
                    </div>
					 <div class="passwd">
			<form:input path="password" type="password" placeholder="Enter Your password"/><br><br>
			<label>Password</label>
                    </div>
					<div class="submit">
			<input type="submit" class="dark" value="login"/>
			</div>
			</form:form>
